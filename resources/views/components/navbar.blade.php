...
<nav x-data="{ open: false }" class="bg-gray-800 text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex justify-between w-full">
                ...
                <div class="hidden space-x-6 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('dashboard')">
                        <x-icon name="chart-pie" class="w-4 h-4" solid />
                        <span class="font-medium text-sm">My submissions</span>
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('dashboard')">
                        ...
                        <span class="font-medium text-sm">User area</span>
                    </x-nav-link>
                    @endif
                    @else
                    <x-nav-link :href="route('dashboard')">
            ...
            @if(Auth::check() && $app===true)
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-100 focus:outline-none transition ease-in-out duration-150">
